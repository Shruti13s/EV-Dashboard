    ...
    datasets: [
      {
        data: counts, 
        backgroundColor: [
          'rgba(75, 192, 192, 0.2)', // BEV (Battery Electric Vehicle)
          'rgba(153, 102, 255, 0.2)', // PHEV (Plug-in Hybrid Electric Vehicle)
          'rgba(255, 159, 64, 0.2)',  // FCEV (Fuel Cell Electric Vehicle)
          'rgba(54, 162, 235, 0.2)',  // Other vehicle types
        ],
        borderColor: [
          'rgba(75, 192, 192, 1)', // BEV border color
          'rgba(153, 102, 255, 1)', // PHEV border color
          'rgba(255, 159, 64, 1)',  // FCEV border color
          'rgba(54, 162, 235, 1)',  // Other border color
        ],
        borderWidth: 1,
      },
    ],
